...
use Mahfuz\Nestedset\NestedSet;
...
class NodeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testToTreeWithSpecifiedRoot()
    {
        ...
        $tree1 = \Mahfuz\Nestedset\Collection::make($nodes)->toTree(5);
        $tree2 = \Mahfuz\Nestedset\Collection::make($nodes)->toTree($node);
